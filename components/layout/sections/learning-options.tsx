...
export const LearningOptionsSection = () => {
  return (
    <section
      id="learning-options"
      className="w-full bg-muted/30 py-16 sm:py-24"
    >
      <div className="container">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="text-xl text-muted-foreground">
            Every curriculum track is available at our Karachi and Lodhran
            campuses or through live online sessions on Zoom and Google Meet
            — designed for women building remote careers from anywhere in
            Pakistan.
          </p>
        </div>

        <div className="mt-10 flex justify-center">
          <div className="inline-flex items-center gap-2 rounded-full border border-secondary bg-background px-4 py-2 text-sm text-muted-foreground">
