...
export const TeamSection = () => {
  ...
  return (
    <section id="team" className="w-full bg-muted/30 py-16 sm:py-24">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {teamList.map(({ firstName, lastName, positions }, index) => {
            ...
            return (
              <Card
                key={index}
                className="bg-background dark:bg-card flex flex-col h-full overflow-hidden transition-shadow hover:shadow-md"
              >
